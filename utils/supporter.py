        ...
        },
        {
            ...
            "content": [
                {"type": "text", "text": (
                    ...
                    "3. *Variable Changes Overview*:\n"
                    "   - Summarize significant variable changes throughout the process.\n"
                    "   - Explain how these changes might have affected the process and potentially led to the error.\n"
                    "   - Highlight any unexpected or illogical variable values.\n\n"
